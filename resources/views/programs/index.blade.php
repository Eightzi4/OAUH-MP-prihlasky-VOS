...
@section('content')
    <div class="w-full max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            <div class="inline-flex items-center px-3 py-1 rounded-full bg-white/80 backdrop-blur-md text-xs font-bold mb-6 border border-gray-200 shadow-sm">
        ...
        <div class="group relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/60 ring-1 ring-black/5 flex flex-col lg:flex-row min-h-[500px] transition-all duration-500 hover:shadow-red-900/5">
            ...
            <div class="w-full lg:w-3/5 p-8 sm:p-10 flex flex-col justify-between relative">
                <div class="absolute top-0 right-0 p-10 opacity-5 pointer-events-none">
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-64 w-64 text-school-primary" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-lg leading-relaxed mb-10 max-w-2xl">
                        ...
                        Absolventi získají kvalifikaci pro práci ve státní správě, v právních kancelářích nebo v managementu firem.
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 mb-10 border-t border-b border-gray-200/60 py-8">
                        <div class="flex flex-col">
                            ...
                            <span class="text-lg font-bold text-gray-900 flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-school-primary" viewBox="0 0 20 20" fill="currentColor"><path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z" /></svg>
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-lg font-bold text-gray-900">2 500 Kč / rok</span>
                        </div>

                        <div class="flex flex-col">
                            <span class="text-xs font-bold text-gray-400 uppercase tracking-wide mb-1">Místo výuky</span>
                            <span class="text-lg font-bold text-gray-900">Uherské Hradiště</span>
                        </div>

                        <div class="flex flex-col">
                            <span class="text-xs font-bold text-gray-400 uppercase tracking-wide mb-1">Jazyk výuky</span>
                            <span class="text-lg font-bold text-gray-900">Čeština</span>
                        </div>
                    </div>
                </div>
