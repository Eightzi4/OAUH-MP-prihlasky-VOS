...
<head>
    ...
    <title>Přihlášení do E-přihlášky</title>
    <style>
        body {
            margin: 0;
            padding: 0;
                    ...
                    <tr>
                        <td class="card" style="padding: 50px 40px; text-align: center;">
                            ...
                            <p style="margin: 0; font-size: 16px; line-height: 28px; color: #4b5563;">
                                Vyžádali jste si odkaz pro přihlášení do systému E-přihlášek VOŠ OAUH. Pro vstup
                            ...
                            <p style="margin: 0; font-size: 13px; color: #9ca3af;">
                                Odkaz je platný 30 minut (do {{ $expiresAt->format('d.m.Y H:i') }}).
                            </p>

                            <p style="margin: 10px 0 0 0; font-size: 13px; color: #9ca3af;">
                                Pokud jste si přihlášení nevyžádali, tento e-mail ignorujte.
                            </p>
                            ...
                            <p style="margin: 0; font-size: 13px; color: #6b7280; line-height: 20px;">
                                ...
                                <br>
                                <a href="{{ $url }}"
                                    style="color: #e30613; text-decoration: underline;">{{ $url }}</a>
                            </p>
